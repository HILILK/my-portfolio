  ...
  return (
    <>
      <main class="flex flex-col items-center">
          ...
          >
            ...
            <Vortex
              ...
              <div className="p-4 max-w-7xl mx-auto relative z-10 w-full pt-10 md:pt-0 flex flex-col items-center">
                ...
                <div className="w-full flex justify-center lg:justify-start mt-5 lg:text-2xl">
            ...
            <div className="w-full rounded-md flex flex-col md:items-center md:justify-center overflow-hidden -z-50 p-5 lg:p-40" id="education">
              {/* <Spotlight
                className="-top-40 left-0 md:left-60 md:-top-20"
                fill="blue"
              />
        ...
        <footer className="w-full pt-10 bg-black">
